...
mongoose.connect("mongodb+srv://admin-sanskar:iH1uVpHWIWCBqnm0@cluster0.epaeljf.mongodb.net/blogDB");
...
app.post("/compose", function(req, res) {
  const blogPost = new Post({
    ...
    truncPost: _.truncate(req.body.postContent, {'length': 100})
  });
  blogPost.save((err) => {
    if(!err) {
      res.redirect("/");
